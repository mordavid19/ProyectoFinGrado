...
<body>
<header class="header">
    <h1 class="logo"><a href="index.php" style="text-decoration: none; color: inherit;">FitnessPro</a></h1>
    <nav class="nav">
    ...
    <div class="pricing-row">
      <div class="pricing-card">
        ...
        <div class="pricing-footer">
          <a href="Publico/register.php?precio=30" class="cta-button">¡QUIERO ESTA!</a>
        </div>
      </div>
      ...
      <div class="pricing-card">
        ...
        <div class="pricing-footer">
          <a href="Publico/register.php?precio=90"  class="cta-button">¡LA QUIERO!</a>
        </div>
      </div>
      ...
      <div class="pricing-card recommended">
        ...
        <div class="pricing-footer">
          <a href="Publico/register.php?precio=150" class="cta-button">¡ME APUNTO!</a>
        </div>
      </div>
    </div>
